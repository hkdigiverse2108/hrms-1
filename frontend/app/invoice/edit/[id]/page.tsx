      ...
      try {
        ...
        if (res.ok) {
          ...
          if (active) {
            ...
            setNotes(data.notes || "");
            setOtherBankName(data.otherBankName || "");
            setOtherBankAccount(data.otherBankAccount || "");
            ...
            if (data.lineItems && data.lineItems.length > 0) {
              setItems(data.lineItems.map((item: any, idx: number) => ({
                ...
                discount: item.discountRate !== undefined ? item.discountRate.toString() : (item.discount ? ((item.discount / item.amount) * 100).toFixed(2) : "0"),
